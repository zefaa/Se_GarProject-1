...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav navbar-default bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url() ?>Admin/Pedoman">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url() ?>DataSeminaris/index">
          <i class="fas fa-fw fa-table"></i>
          <span>Data Seminaris</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?= base_url() ?>Admin/Rekapitulasi">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline">
            <div>
              <div>
                <h3>Keuangan Seminaris Seminari Garum</h3>
